...
course_namespace = Namespace('Courses', description='Operation on courses')
...
# class ACourse(Resource):
#     def get(self):
#         """
#             Get all students registered in a curse
#         """
#         pass
...
class AddDropCourseStudent(Resource):
    ...
    def delete(self, course_id, student_id):
        ...
        return {
                   "message": f"{student.first_name} {student.last_name} has been successfully removed from {course.name}"}, HTTPStatus.OK
