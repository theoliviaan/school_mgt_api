...
from ..utils.grade_conversion import get_letter_grade, convert_grade_to_gpa
...
class GetAddUpdateGrades(Resource):
    ...
    def post(self, student_id):
        ...
        if not student_course:
            return {
                       "message": f"{student.first_name} {student.last_name} is not taking {course.name}"}, HTTPStatus.NOT_FOUND
